...
namespace vloam {
    ...
    void VloamTF::VO2VeloAndBase(const tf2::Transform& cam0_curr_VOT_cam0_last) {
        ...
        velo_last_VOT_velo_curr = velo_T_cam0 * cam0_curr_VOT_cam0_last.inverse() * velo_T_cam0.inverse(); // odom for velodyne
    ...
    void VloamTF::VO2Cam0StartFrame(FILE *VOFilePtr, const int count) {
        ...
        if (VOFilePtr != NULL) {
            fprintf(
                ...
                cam0_start_eigen_VOT_cam0_last(0, 1),
                cam0_start_eigen_VOT_cam0_last(0, 2),
                cam0_start_eigen_VOT_cam0_last(0, 3),
                cam0_start_eigen_VOT_cam0_last(1, 0),
                cam0_start_eigen_VOT_cam0_last(1, 1),
                cam0_start_eigen_VOT_cam0_last(1, 2),
                cam0_start_eigen_VOT_cam0_last(1, 3),
                cam0_start_eigen_VOT_cam0_last(2, 0),
                cam0_start_eigen_VOT_cam0_last(2, 1),
                cam0_start_eigen_VOT_cam0_last(2, 2),
    ...
    void VloamTF::LO2Cam0StartFrame(FILE *LOFilePtr, const int count) {
        ...
        if (LOFilePtr != NULL) {
            fprintf(
                ...
                cam0_start_eigen_LOT_cam0_last(0, 1),
                cam0_start_eigen_LOT_cam0_last(0, 2),
                cam0_start_eigen_LOT_cam0_last(0, 3),
                cam0_start_eigen_LOT_cam0_last(1, 0),
                cam0_start_eigen_LOT_cam0_last(1, 1),
                cam0_start_eigen_LOT_cam0_last(1, 2),
                cam0_start_eigen_LOT_cam0_last(1, 3),
                cam0_start_eigen_LOT_cam0_last(2, 0),
                cam0_start_eigen_LOT_cam0_last(2, 1),
                cam0_start_eigen_LOT_cam0_last(2, 2),
    ...
    void VloamTF::MO2Cam0StartFrame(FILE *MOFilePtr, const int count) {
        ...
        if (MOFilePtr != NULL) {
            fprintf(
                ...
                cam0_start_eigen_MOT_cam0_last(0, 1),
                cam0_start_eigen_MOT_cam0_last(0, 2),
                cam0_start_eigen_MOT_cam0_last(0, 3),
                cam0_start_eigen_MOT_cam0_last(1, 0),
                cam0_start_eigen_MOT_cam0_last(1, 1),
                cam0_start_eigen_MOT_cam0_last(1, 2),
                cam0_start_eigen_MOT_cam0_last(1, 3),
                cam0_start_eigen_MOT_cam0_last(2, 0),
                cam0_start_eigen_MOT_cam0_last(2, 1),
                cam0_start_eigen_MOT_cam0_last(2, 2),
